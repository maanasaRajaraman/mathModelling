...
# Eulers and Runge Kutta
import matplotlib.pyplot as plt

# Example ODE: dy/dx = f(x, y)
def f(x, y):
    return x + y
...
def runge_kutta_4th_order(f, x0, y0, h, num_steps):
    x_values = [x0]
    y_values = [y0]
    x = x0
    y = y0
